    ...
    >
      <nav class=" text-white bg-cyan-800 sticky left-auto top-0 right-0 py-3">
        ...
        <div class="h-10 px-6 flex relative items-center justify-end">
          <button class="relative block absolute bottom-6 h-12 w-12 rounded-full overflow-hidden shadow focus:outline-none">
            <img
        ...
        <div className=" h-screen px-3 bg-gray-50 rounded dark:bg-gray-800 bg-gray-400">
          ...
          <ul className="space-y-2">
            ...
            {/* <li>
              <Link
                to="/admin/users"
                className="flex items-center p-2 text-base font-normaltext-black  rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                <svg
                  className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                  fill="currentColor"
